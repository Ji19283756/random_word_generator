...
def display_names(list_of_names: list, columns: int):
    ...
    for array_row in arranged_array:
        print(array_row)


def name_does_not_have_nonexistent_triple_or_double(name: list) -> bool:
    ...
    return not any(pair in name for pair in pairs_that_do_not_exist) or \
